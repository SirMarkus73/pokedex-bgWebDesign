    ...
    <main class="p-6 flex flex-col gap-3">
                        ...
                        <div class="modal-box flex flex-col border border-gray-300 p-2 rounded-md mb-4 text-red-700 bg-neutral-50 dark:text-neutral-100 dark:bg-neutral-900 gap-5">
                            ...
                            <form action="../services/change_username.php" method="post">
                                <label for="newUsername">Nuevo usuario:
                                    <input class="bg-neutral-200 dark:bg-black" type="text" name="newUsername" required>
                                </label>
        ...
        <article class=" md:col-span-2 border border-red-600 dark:border-fuchsia-700 py-3">
            ...
            <section class="flex flex-row p-10">
                <p> Light Mode </p>
                <input type="checkbox" class="toggle  bg-neutral-200 hover:bg-red-700 border-neutral-200 dark:[--tglbg:fuchsia] dark:bg-neutral-200 dark:hover:bg-fuchsia-600 dark:border-neutral-800" class="color: white" id="toggle-dark-mode" />
                <p> Dark Mode</p>
            </section>
        </article>
